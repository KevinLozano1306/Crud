...
if (isset($_POST['id'])) { // Corregir la verificación del identificador
    $ID = $_POST['id']; // Obtener el identificador corregido
    ...
    $resultado = $query->execute(array($RAM, $Procesador, $Disco, $GPU, $Unidades, $Precio, $ID)); // Agregar el ID al array de parámetros
    if ($resultado) {
        $correcto = true;
    }
} else {
